...
export const getTimelines = BaseUrl + 'timelines'
export const addTimelines = BaseUrl + 'upload_images'
export const filter = BaseUrl + 'filter'
export const getPortfolio = GraphQLUrl + 'graphql'
export const getSinglePortfolio = WordPressRestApiBaseURL;